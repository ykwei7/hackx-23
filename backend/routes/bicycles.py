...
@bp.route('/bicycles', methods=['POST'])
def add_bicycle():
    ...
    last_seen_lon = data.get('last_seen_lon')
...
@bp.route('/bicycles/<string:bicycle_id>', methods=['DELETE'])
...
@bp.route('/bicycles/<string:bicycle_id>', methods=['PUT'])
